      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            >
              <Popover.Panel
                className="absolute bg-white -left-8 top-full
              z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl 
              ...
              >
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-2 divdie-x divide-gray-900/5 bg-gray-50">
                    {callsToAction.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="flex items-center
                      justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 
        ...
        >
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Bookgin.com</span>
              <img
